...
(*Definition of maps used to store memories and stacks at given labels*)
...
(*Function that returns a under-specified term for invalid memory access *)
...
(*Function to evaluate a term as a right-value*)
...
(*Function to evaluate a term as a left-value*)
